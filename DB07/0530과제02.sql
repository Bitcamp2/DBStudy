...
CREATE TABLE PAYMENT_DETAIL(
	...
	TOTAL_PRICE NUMBER(30) NOT NULL CHECK(TOTAL_PRICE > 0),
	CONSTRAINT PK_MNO_PNO_PAYMENT PRIMARY KEY(MNO, PNO),
	CONSTRAINT FK_MNO_PAYMENT FOREIGN KEY(MNO)
		REFERENCES PAYMENT(MNO),
	CONSTRAINT FK_PNO_PAYMENT FOREIGN KEY(PNO)
